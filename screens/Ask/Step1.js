    ...
    return (
        <View style={styles.step_1}>
                <ScrollView style={styles.question_input_view}>
                    <TextInput onChangeText={(txt)=>{props.setQuestion(txt)}} value={props.question} style={styles.question_input} placeholder='Enter your Question' multiline={true}/>
                    {question_img?
                ...
                <TouchableOpacity onPress={()=>pickFile(setQuestionImg)} style={styles.upload_btn}>
                        <MaterialCommunityIcons style={styles.icon} name="image" color='black' size={24} />
